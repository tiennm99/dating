...
export const vi: SiteCopy = {
	...
	home: {
		metaTitle: 'Tiến Nguyễn Minh | Mô tả & hồ sơ hẹn hò',
		metaDescription: 'Mô tả hẹn hò và hồ sơ cá nhân ấm áp, dí dỏm của Tiến Nguyễn Minh.',
	...
	jd: {
		...
		responsibilitiesTitle: 'Điều cả hai cùng bảo vệ.',
		responsibilities: [
