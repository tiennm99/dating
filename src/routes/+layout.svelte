<script>
	...
	import { initializeTheme, setTheme, theme, themeOptions } from '$lib/theme';
...
<svelte:head>
	...
	<meta property="og:image:alt" content={copy.layout.socialImageAlt} />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:image:alt" content={copy.layout.socialImageAlt} />
	<meta
		name="twitter:image"
		content="https://tiennm99.github.io/dating/assets/social/dating-jd-cv-social-preview.png"
	/>
